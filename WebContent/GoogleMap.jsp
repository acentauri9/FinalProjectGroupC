...
<body>
    ...
    <script>
      ...
      function search() {
	var dataCap = document.getElementById("BusinessList").value;
        var search = {
          bounds: map.getBounds(),
          types: [dataCap]            //select the type of business
        };
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCx4WScqcmAUFhKd4uq6axPD968hrokLOM&libraries=places&callback=initMap"
        async defer></script>
